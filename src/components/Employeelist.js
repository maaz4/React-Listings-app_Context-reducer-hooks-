...
export const Employeelist = () => {
    const { useEffect, removeEmployee, editEmployee } = useContext(GlobalContext);
    return (
        <Fragment>
            {useEffect.length > 0 ? <Fragment>
                {useEffect.map(employee => (
                    <div className="flex items-center bg-gray-100 mb-10 shadow" key={employee.name}>
